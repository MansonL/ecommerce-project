...
export class EmailUtilities {
    ...
    static createHTMLOrderEmail = (products: OrderProducts[], htmlAddress: string, total: number, customerOrAdminMessages: [string, string]): string => {
        ...
        return  htmlGeneral.concat(`<h2>${customerOrAdminMessages[0]}</h2><h4>Here are the details:</h4>`.
